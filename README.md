...
To use the engine, either grab the binary from releases, or build the project locally. Note that from version 0.25 onwards you need to give it 2 cores, or
it may make illegal moves.
...
- nemequ, mbitsnbites, zhuyie et al. for [TinyCThread](https://github.com/tinycthread/tinycthread/tree/master). Used to make input/search threads.
...
## Changelogs: <br>
### 0.x: <br>
0.25: Enabled O3 optimisation. Added search thread. Fixed hash entry / PV truncation issues. | Elo gain: ~60. <br>
